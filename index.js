...
async function amazonScrapping() {
  try {
    ...
    $(".a-color-base.a-text-bold").each((index, tag) => {
      ...
      data[index].availability = $(tag).text();
    });
